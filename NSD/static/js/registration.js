...
document.addEventListener("DOMContentLoaded", function () {
    const dropdownSelected = document.querySelector(".register-dropdown-selected");
    const dropdownList = document.querySelector(".register-dropdown-list");
    const dropdownArrow = document.querySelector(".register-dropdown-arrow");
    ...
    dropdownSelected.addEventListener("click", function () {
        ...
        dropdownSelected.classList.toggle("register-dropdown-open");
    });

    // Select country
    document.querySelectorAll(".register-dropdown-item").forEach(item => {
        item.addEventListener("click", function () {
            ...
            dropdownSelected.classList.remove("register-dropdown-open");
        });
    });
...
document.addEventListener("DOMContentLoaded", function () {
    const dropdownSelected = document.querySelector(".applicant-register-dropdown-selected");
    const dropdownList = document.querySelector(".applicant-register-dropdown-list");
    const dropdownArrow = document.querySelector(".applicant-register-dropdown-arrow");
    ...
    dropdownSelected.addEventListener("click", function () {
        dropdownList.style.display = dropdownList.style.display === "block" ? "none" : "block";
        dropdownSelected.classList.toggle("applicant-register-dropdown-open");
    });

    // Select country
    document.querySelectorAll(".applicant-register-dropdown-item").forEach(item => {
        item.addEventListener("click", function () {
            let flag = this.getAttribute("data-flag");
            let code = this.getAttribute("data-code");
            ...
            dropdownList.style.display = "none";
            dropdownSelected.classList.remove("applicant-register-dropdown-open");
        });
    });
...
function handleRegistrationFormSubmit(event) {
    ...
    var state_of_origin = document.getElementById('stateoforigin').value;
    var lga = document.getElementById('lga').value;
    var place_of_birth = document.getElementById('place').value;
    var occupation = document.getElementById('profession').value;
    var marital_status = document.getElementById('marital').value;
    ...
    var spinner = document.querySelector('.register-spinner');
    var buttonText = document.querySelector('.register-button-text');
    var form = document.getElementById('registration-form');

    // && profile_picture

    // Check if all fields are filled
    if (surname && firstname && others && maiden && sex && dob && blood && facial && glasses && height && disability && nin && next_of_kin_phone && applicant_phone && nationality && state_of_origin && 
        lga && place_of_birth && occupation && marital_status && residential_address && email && programme && terms
    ) {
...
document.addEventListener("DOMContentLoaded", function() {
    let errorContainer = document.getElementById("register-error-container");
...
function fetchDuration() {
    ...
    fetch(`/get-duration/${ProgrammeID}`)
        .then(response => {
        ...
        .catch(error => {
            ...
            durationSelect.innerHTML = '<option value="" disabled selected>Error loading Durations</option>';
        });
}
